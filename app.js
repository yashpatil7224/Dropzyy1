...
async function sendBillViaEmailJS(toEmail, toName, orderObj) {
    ...
    const templateParams = {
        ...
        // Order Information / Details / Items Summary Aliases
    ...
    try {
        ...
        console.warn('EmailJS SDK bill error, trying REST API fallback:', err);
    }
